...
export const ChangeQuantityOfBook: React.FC<{book : BookModel , deleteBook:any } > = (props,key) => {
    ...
    async function increaseQuantity() {
        const url=`${process.env.REACT_APP_HOST}/api/admin/increase/book/quantity/?bookId=${props.book?.id}`;
    ...
    async function deleteBook() {
        const url=`${process.env.REACT_APP_HOST}/api/admin/delete/book/?bookId=${props.book?.id}`;
